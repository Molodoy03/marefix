...
function inclusion_enqueue() {
    wp_enqueue_style('main', get_template_directory_uri() . '/styles/main1ec8bd89cbdf14bd8edb.css', [], '', 'all');
    wp_enqueue_style('style', get_template_directory_uri() . '/style.css', ['main'], '', 'all');

    wp_enqueue_script('scripts', get_template_directory_uri() . '/scripts/main1ec8bd89cbdf14bd8edb.js', ['jquery'], '', true);
}
